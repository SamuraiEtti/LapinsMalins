...
$operation_legitime=["index","log"];
if(isset($_GET['page'],$operation_legitime)){
    $page=$_GET['page'];
}else{$page="log";
     }
$page = (isset($_GET['page'])) ? $_GET['page'] : "log";//par defaut il va en index
...
switch($page) {
    case "index":
        ...
        break;
    case "log":
        include_once 'Template/log.html';
